...
public class PriorityTestNg {
  ...
  public void helpCenter() throws InterruptedException{
	  ...
	  WebElement webelement = driver.findElement(By.xpath("//*[@id=\"react-root\"]/div/main/div/div/nav/a[2]"));
	  webelement.click();
	  String expectedTitle = "Help Center";
	  Thread.sleep(2000);
	  String actualTitle = driver.getTitle();
  ...
  public void signUp() throws InterruptedException{
	  ...
	  Thread.sleep(5000);
	  String actualTitle = driver.getTitle();
	  System.out.println("On Sign Page :" + actualTitle);
	  Assert.assertEquals(actualTitle, expectedTitle);
  }
